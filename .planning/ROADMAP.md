...
**Requirements**: ENRICH-01, ENRICH-02, ENRICH-06, ENRICH-07, ENRICH-08, ENRICH-09
**Success Criteria** (what must be TRUE):
...
**Requirements**: ENRICH-03, ENRICH-04, ENRICH-05, ENRICH-10
**Success Criteria** (what must be TRUE):
  ...
  4. AI cleanup service uses a provider-agnostic LLM interface so Gemini can be swapped for Ollama/Qwen in v1.6 via admin settings without code changes
**Plans**: TBD
